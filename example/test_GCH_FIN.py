...
from NeuralGraph.model import GCH_FIN
...
def main():
    ...
    with Timer() as t3:
        ...
        print('data load:')
    with Timer() as t4:
        net = GCH_FIN(hid_dim_m=128, hid_dim_p=100, n_class=1, save_path='output/records/GCH_FIN_results.txt')
        net = net.fit(train_loader, valid_loader, epochs=N_EPOCH, path='output/GCH_FIN')
