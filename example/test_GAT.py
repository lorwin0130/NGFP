...
from NeuralGraph.model import GAT
...
def main():
    ...
    with Timer() as t3:
        ...
        print('data load:')
    with Timer() as t4:
        net = GAT(hid_dim_m=216, hid_dim_p=512, n_class=1, save_path='output/records/GAT_results.txt')
        net = net.fit(train_loader, valid_loader, epochs=N_EPOCH, path='output/GAT')
